...
public class DSpaceCollectionManifestControllerTest {
    ...
    public void testGetCollectionManifest() throws Exception {
        ...
        when(dSpaceCollectionManifestService.getManifest(any(String.class), any(Boolean.class))).thenReturn(expected);
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/dspace/collection?context=123456789/158298").accept(MediaType.APPLICATION_JSON);
