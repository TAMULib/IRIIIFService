...
public class FedoraPcdmCanvasManifestControllerTest extends AbstractManifestControllerTest {
    ...
    public void testGetManifest() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/" + fedoraPcdmIdentifier + "/canvas/cars_pcdm_objects/chevy/pages/page_0").accept(MediaType.APPLICATION_JSON);
