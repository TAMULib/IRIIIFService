...
public class DSpaceRdfPresentationManifestServiceTest extends AbstractDSpaceRdfManifestServiceTest {
    ...
    public void testGetCollectionManifest() throws IOException, URISyntaxException {
        ...
        when(httpService.get(eq(DSPACE_URL + "/rdf/handle/123456789/158316"))).thenReturn(readFileToString(rdf.getFile(), "UTF-8"));
        when(httpService.get(eq(DSPACE_URL + "/rdf/handle/123456789/158317"))).thenReturn(readFileToString(rdf.getFile(), "UTF-8"));
        when(httpService.get(eq(DSPACE_URL + "/rdf/handle/123456789/158310"))).thenReturn(readFileToString(rdf.getFile(), "UTF-8"));
        when(httpService.get(eq(DSPACE_URL + "/rdf/handle/123456789/158307"))).thenReturn(readFileToString(rdf.getFile(), "UTF-8"));
        when(httpService.get(eq(DSPACE_URL + "/rdf/handle/123456789/158313"))).thenReturn(readFileToString(rdf.getFile(), "UTF-8"));
        when(httpService.get(eq(DSPACE_URL + "/rdf/handle/123456789/158312"))).thenReturn(readFileToString(rdf.getFile(), "UTF-8"));
