...
import static edu.tamu.iiif.constants.Constants.PRESENTATION_MAPPING;
...
public class FedoraPcdmPresentationManifestController extends AbstractManifestController<FedoraPcdmPresentationManifestService> {

    @GetMapping(PRESENTATION_MAPPING)
