...
import edu.tamu.iiif.service.fedora.FedoraPcdmSequenceManifestService;
...
public class FedoraPcdmSequenceManifestController extends AbstractManifestController<FedoraPcdmSequenceManifestService> {

    @GetMapping("/" + SEQUENCE_IDENTIFIER + "/**/*")
